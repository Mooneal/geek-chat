...
import com.geekerstar.enums.MsgActionEnum;
import com.geekerstar.enums.MsgSignFlagEnum;
import com.geekerstar.enums.SearchFriendsStatusEnum;
import com.geekerstar.mapper.ChatMsgMapper;
import com.geekerstar.mapper.FriendsRequestMapper;
import com.geekerstar.mapper.MyFriendsMapper;
import com.geekerstar.mapper.UsersMapper;
import com.geekerstar.mapper.UsersMapperCustom;
import com.geekerstar.netty.ChatMsg;
import com.geekerstar.netty.DataContent;
import com.geekerstar.netty.UserChannelRel;
import com.geekerstar.pojo.FriendsRequest;
import com.geekerstar.pojo.MyFriends;
...
import com.geekerstar.utils.QRCodeUtils;
...
public class UserServiceImpl implements UserService {
	...
	public String saveMsg(ChatMsg chatMsg) {
		...
		com.geekerstar.pojo.ChatMsg msgDB = new com.geekerstar.pojo.ChatMsg();
	...
	@Transactional(propagation = Propagation.SUPPORTS)
	@Override
	public List<com.geekerstar.pojo.ChatMsg> getUnReadMsgList(String acceptUserId) {

		Example chatExample = new Example(com.geekerstar.pojo.ChatMsg.class);
		Criteria chatCriteria = chatExample.createCriteria();
		chatCriteria.andEqualTo("signFlag", 0);
		chatCriteria.andEqualTo("acceptUserId", acceptUserId);

		List<com.geekerstar.pojo.ChatMsg> result = chatMsgMapper.selectByExample(chatExample);
